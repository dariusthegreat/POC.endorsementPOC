...
public partial class InsuranceDbContext : DbContext
{
    ...
    public virtual DbSet<AgentStateLicense> AgentStateLicenses { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<AgentStateLicense>(entity =>
        {
            entity.HasKey(e => new { e.AgencyId, e.StateId }).HasName("pk_agent_state_license");

            entity.ToTable("agent_state_license");
            ...
            entity.Property(e => e.AgentLicenseNumber)
                .HasMaxLength(50)
                .IsUnicode(false)
                .HasColumnName("agent_license_number");
            ...
            entity.HasOne(d => d.Agency).WithMany(p => p.AgentStateLicenses)
                .HasForeignKey(d => d.AgencyId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("fk_agent_state_license__agency_agents");
        });
