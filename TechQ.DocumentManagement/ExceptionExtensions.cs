...
public static class ExceptionExtensions
{
	...
	public static void Format(this Exception exception, TextWriter output, FomattingOptions options) => exception.Format(output, options.Fields);
	...
	public static void FormatSingleException(this Exception exception, TextWriter output, FomattingOptions options) => exception.FormatSingleException(output, options?.Fields ?? throw new ArgumentNullException(nameof(options)) /* irony!! */);
	...
	public static void FormatSingleException(this Exception exception, TextWriter output, ExceptionFields fields = ExceptionFields.All)
	{
		...
		if ((fields & ExceptionFields.Stacktrace) == ExceptionFields.Stacktrace)
		{
			output.WriteLine("\nStacktrace:");
			output.WriteLine(exception.StackTrace);
		}

		if ((fields & ExceptionFields.Data) == ExceptionFields.Data && exception?.Data.Count > 0)
		{
	...
	public record FomattingOptions(bool IncludeStacktrace=true, bool IncludeExceptionData=true, bool IncludeInnerExceptions=true)
	{
		public ExceptionFields Fields => 										ExceptionFields.HelpLink 		
											|									ExceptionFields.HResult 		
											|									ExceptionFields.Source 			
											|									ExceptionFields.TargetSite 		
											|	(IncludeStacktrace			? 	ExceptionFields.Stacktrace 		: ExceptionFields.None) 
